...
```bash
python -m stage1.train --data_root /path/to/data --scale 0.25 --chunk_size 64 --epochs 10 --out_dir stage1_checkpoints
```
...
- **dataloader.py**: `load_photoncube`, `downsample_frames`, `PhotonCubeDataset`, `load_sample`, `naive_sum`.
